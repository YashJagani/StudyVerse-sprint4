...
const CourseProgress = () => {
  ...
  const allLecturesViewed = courseDetails.lectures.every((lec) => isLectureCompleted(lec._id));
              ...
              <Card className="mb-3">
                <CardContent className="flex items-center justify-between p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <CardTitle className="text-lg font-medium">Final Quiz</CardTitle>
                    </div>
                  </div>
                  <Button
                  ...
                  >
                    {allLecturesViewed ? "Start Quiz" : "Complete Lectures First"}
                  </Button>
                </CardContent>
              </Card>
            )}
